...
*/
namespace FFmpeg.libavcodec
{
	public unsafe static partial class avcodec
	{
		/**
		...
		public struct AVCodecDescriptor
		{
			 ...
			 */
			public /*const*/ char /**const*/ *mime_types;
			/**
			 * If non-NULL, an array of profiles recognized for this codec.
			 * Terminated with FF_PROFILE_UNKNOWN.
			 */
			public /*const*/ AVProfile *profiles;
		}
		...
		*/
		...
		#define FF_MB_DECISION_RD     2        ///< rate distortion
			 ...
			 */
			public int (*get_buffer2)(AVCodecContext *s, AVFrame *frame, int flags);
		...
		#define AV_EF_AGGRESSIVE (1<<18)        ///< consider things that a sane encoder should not do as an error
			 ...
			 * - decoding: Set by libavcodec
			 */
			public /*const*/ AVHWAccel *hwaccel;
			 ...
			 * - decoding: unused
			 */
			public ulong error[AV_NUM_DATA_POINTERS];
		...
		#define FF_THREAD_SLICE   2 ///< Decode more than one part of a single frame at once
			 ...
			 * - decoding: Set by libavcodec, user can override.
			 */
			public int (*execute)(struct AVCodecContext *c, int (*func)(struct AVCodecContext *c2, void *arg), void *arg2, int *ret, int count, int size);
			 ...
			 * - decoding: Set by libavcodec, user can override.
			 */
			public int (*execute2)(struct AVCodecContext *c, int (*func)(struct AVCodecContext *c2, void *arg, int jobnr, int threadnr), void *arg2, int *ret, int count);
		...
		#define FF_LEVEL_UNKNOWN -99
			 ...
			 * - decoding: set by libavcodec.
			 */
			public /*const*/ AVCodecDescriptor *codec_descriptor;
		...
		public struct AVCodec
		{
			...
			public /*const*/ AVRational *supported_framerates; ///< array of supported framerates, or NULL if any, array is terminated by {0,0}
			public /*const*/AVPixelFormat *pix_fmts;     ///< array of supported pixel formats, or NULL if unknown, array is terminated by -1
			public /*const*/ int *supported_samplerates;       ///< array of supported audio samplerates, or NULL if unknown, array is terminated by 0
			public /*const*/AVSampleFormat *sample_fmts; ///< array of supported sample formats, or NULL if unknown, array is terminated by -1
			public /*const*/ulong *channel_layouts;         ///< array of support channel layouts, or NULL if unknown. array is terminated by 0
			public byte max_lowres;                     ///< maximum value for lowres supported by the decoder
			public /*const*/AVClass *priv_class;              ///< AVClass for the private context
			public /*const*/AVProfile *profiles;              ///< array of recognized profiles, or NULL if unknown, array is terminated by {FF_PROFILE_UNKNOWN}
			 ...
			 */
			public /*const*/ char *wrapper_name;
